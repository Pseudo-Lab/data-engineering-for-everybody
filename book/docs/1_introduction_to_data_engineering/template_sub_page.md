...
![오늘 이 시간은 저를 포함한 스터디 러너분들의 물음에서 시작된 질문에 대한 답을 하는 시간입니다. 앞으로 다루게 될 데이터 엔지니어링에 대해서 궁금증을 갖고 그 물음을 하나씩 채워나갈 수 있는 시간이 되셨으면 좋겠습니다!](./sub_page_imgs/Untitled%201.png)
...
![Untitled](./sub_page_imgs/Untitled%202.png)
...
![Untitled](./sub_page_imgs/Untitled%203.png)
...
![데이터를 정보로서 읽고 이해하고 생성하고 전달할 수 있는 역량이 중요해지는 시대에 살고있습니다.](./sub_page_imgs/Untitled%204.png)

데이터를 정보로서 읽고 이해하고 생성하고 전달할 수 있는 역량이 중요해지는 시대에 살고있습니다.

- `데이터 분석 및 해석 능력(살펴보기)`
    
    ![데이터를 분석하고 해석하는 역량을 ‘Data Literacy’라고 정의할 수 있습니다. 위키피디아에서는 ‘Data Literacy’를 다음과 같이 정의했습니다. 데이터를 정보로 읽고 이해하고 생성하고 전달할 수 있는 능력이다. 데이터 작업과 관련된 역량에 중점을 둔다. 데이터를 읽고 이해하기 위해서 기술적인 역량이 필요할수도 있다.](./sub_page_imgs/Untitled%205.png)
...
![지금은 이 다이어그램이 이해가 되지 않으셔도 됩니다! 오늘의 목표는 마지막에 이 다이어그램의 의미를 이해하는 것입니다!](./sub_page_imgs/Untitled%206.png)
...
- `📌 Data Engineer vs Data Scientist by [DataCamp](https://www.datacamp.com/blog/data-scientist-vs-data-engineer)`
    ...
    ![Untitled](./sub_page_imgs/Untitled%207.png)
    ...
    ![Untitled](./sub_page_imgs/Untitled%208.png)
    ...
    ![데이터 자체에 대한 이해.조작을 주로 하는 직무가 데이터 엔지니어라면 이러한 데이터에 기반하여 머신러닝 모형을 만들고 시각화를 하여 경영진에 보고하는 역할을 하는 직무가 데이터 과학자입니다](./sub_page_imgs/Untitled%209.png)
    
    데이터 자체에 대한 이해.조작을 주로 하는 직무가 데이터 엔지니어라면 이러한 데이터에 기반하여 머신러닝 모형을 만들고 시각화를 하여 경영진에 보고하는 역할을 하는 직무가 데이터 과학자입니다
    
    ![Untitled](./sub_page_imgs/Untitled%2010.png)
    
    ![Untitled](./sub_page_imgs/Untitled%2011.png)
    
    ![Untitled](./sub_page_imgs/Untitled%2012.png)
    
    ![2015년 Data Camp의 ‘The Data Science Industry: Who Does What (Infographic)’ 게시글에서는 데이터 엔지니어를 ‘All-purpose everyman’이라고 표현했네요…! 한국에서는 ‘데이터 잡부’라는 오명을 쓰고 있지만… 잡부 보다는 팔방미인이 더 어울리는 직군인 것 같습니다!](./sub_page_imgs/Untitled%2013.png)
...
- Data 직군 비교하기
    ...
    ![Untitled](./sub_page_imgs/Untitled%2014.png)
...
- `~~접어두기~~`
    ...
    데이터를 수집하고(Capture) → 처리하고(Process) → 저장하고(Store) → 분석하고(Analyze) → 활용합니다(Use)](./sub_page_imgs/Untitled%2015.png)
...
![데이터 엔지니어링 생애주기를 떠올리며 하나씩 살펴보도록 하겠습니다!](./sub_page_imgs/Untitled%206.png)
...
- `Serving`: “저장소에 저장된 데이터를 필요한 조직, 서비스에 전달하는 단계”
    ...
    - 셋째, 역 ETL을 통해 데이터를 제공합니다. *`역방향 ETL`은* 데이터를 데이터 원본으로 다시 보내는 프로세스입니다. 예를 들어 광고 기술 플랫폼에서 데이터를 수집하고 이 데이터에 대한 통계 프로세스를 실행하여 클릭당 비용 입찰가를 결정한 다음 이 데이터를 다시 광고 기술 플랫폼에 제공할 수 있습니다. 역 ETL은 BI 및 ML과 매우 얽혀 있습니다.
        ...
        ![Untitled](./sub_page_imgs/Untitled%2016.png)
...
- `Modern Data Like Centric Analytics Platforms`
    ...
    ![Untitled](./sub_page_imgs/Untitled%2017.png)
...
![Untitled](./sub_page_imgs/Untitled%2018.png)

![Untitled](./sub_page_imgs/Untitled%2019.png)
...
- `Data Lineage(Option)`
    ...
    ![Untitled](./sub_page_imgs/Untitled%2020.png)
...
![가짜연구소-Session1. Introduction to DE.drawio.png](./sub_page_imgs/%25E1%2584%2580%25E1%2585%25A1%25E1%2584%258D%25E1%2585%25A1%25E1%2584%258B%25E1%2585%25A7%25E1%2586%25AB%25E1%2584%2580%25E1%2585%25AE%25E1%2584%2589%25E1%2585%25A9-Session1._Introduction_to_DE.drawio.png)
...
![Software Engineer와 Data Engineer의 커리어 패스는 비슷하면서도 다른 점들이 많은 것 같습니다 :)](./sub_page_imgs/Untitled%2021.png)
...
- `Data Reliability Engineering`
    ...
    ![Untitled](./sub_page_imgs/Untitled%2022.png)
    
    ![Untitled](./sub_page_imgs/Untitled%2023.png)
    
    > Why Data Reliability is important
    > 
    
    ![Untitled](./sub_page_imgs/Untitled%2024.png)
    

`주요 포인트`

![Untitled](./sub_page_imgs/Untitled%2025.png)
...
![Untitled](./sub_page_imgs/Untitled%2026.png)
...
![Untitled](./sub_page_imgs/Untitled%2027.png)

![발표자는 데이터 엔지니어링의 종착점은 운영 단계에서 데이터 품질 보장, 데이터 출처 파악 등 데이터의 품질을 향상시키는데 있다고 합니다.](./sub_page_imgs/Untitled%2028.png)

발표자는 데이터 엔지니어링의 종착점은 운영 단계에서 데이터 품질 보장, 데이터 출처 파악 등 데이터의 품질을 향상시키는데 있다고 합니다.

![Untitled](./sub_page_imgs/Untitled%2029.png)

![Untitled](./sub_page_imgs/Untitled%2030.png)
...
![Untitled](./sub_page_imgs/Untitled%2031.png)

![Untitled](./sub_page_imgs/Untitled%2032.png)

> 새벽 2시에 일어나서 부서진 파이프라인을 수정하는 것을 막아준다. 단 2개의 박스로 표현한 심플함!
> 

![출처: [https://modern-cdo.medium.com/taming-data-quality-with-circuit-breakers-dbe550d3ca78](https://modern-cdo.medium.com/taming-data-quality-with-circuit-breakers-dbe550d3ca78)](./sub_page_imgs/Untitled%2033.png)
...
![Untitled](./sub_page_imgs/Untitled%2034.png)

![Uber: Data Quality Platform Architecture](./sub_page_imgs/Untitled%2035.png)
...
- **AWS serverless data analytics pipeline reference architecture (by AWS)**
    ...
    ![Untitled](./sub_page_imgs/Untitled%2036.png)
    ...
    ![Untitled](./sub_page_imgs/Untitled%2037.png)
...
![많은 양의 데이터가 생성되는데 이를 수집.가공.처리하는 `파이프라인을 효율적으로 개선`하는 작업 중에 있습니다.](./sub_page_imgs/Untitled%2038.png)
...
- `할일`
    ...
    ![통합 분석 환경 구성을 위해 데이터 아키텍처는 어떻게 가져가면 좋을지, 해당 파이프라인의 진행 단계마다 데이터 품질을 어떻게 보장하면 좋을지, 결과 데이터를 유의미하게 활용하기 위해서는 어떻게 해야하는지 고민에 고민에 고민을 더합니다…!](./sub_page_imgs/%25E1%2584%2580%25E1%2585%25A1%25E1%2584%258D%25E1%2585%25A1%25E1%2584%258B%25E1%2585%25A7%25E1%2586%25AB%25E1%2584%2580%25E1%2585%25AE%25E1%2584%2589%25E1%2585%25A9-%25E1%2584%2591%25E1%2585%25A6%25E1%2584%258B%25E1%2585%25B5%25E1%2584%258C%25E1%2585%25B5-7.drawio.png)
...
![Untitled](./sub_page_imgs/Untitled%2039.png)
...
- `Comparing data management roles`
    ...
    ![Untitled](./sub_page_imgs/Untitled%2040.png)
...
![Untitled](./sub_page_imgs/Untitled%2041.png)
...
![Untitled](./sub_page_imgs/Untitled%2042.png)
...
- How User Achieves Operational Excellence in the Data Quality Experience
    ...
    ![Untitled](./sub_page_imgs/Untitled%2043.png)
    
    - 우버의 데이터 품질 보장 사례
    - Data Quality Platform Architecture
    
    ![Untitled](./sub_page_imgs/Untitled%2044.png)
